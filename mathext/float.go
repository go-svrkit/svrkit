...
// SignAndMagnitudeToBiasedFloat64 converts an integer from the sign-and-magnitude representation to
...
// IsAlmostEqualFloat64 returns true if this number is at most kMaxUlps ULP's away from
